...
import { showNotification, setIsLoading  } from "../store/authSlice";
    ...
    const onSubmitHandler = async (e) => {
      try {
        ...
        if (enteredPassword !== enteredConfirmPassword) {
          dispatch(showNotification({message:"Passwords don't match, enter again", variant:"danger"}));
          dispatch(setIsLoading(false));
          return;
        }
  
        const endPointUrl = `https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=${process.env.REACT_APP_API_KEY}`;
